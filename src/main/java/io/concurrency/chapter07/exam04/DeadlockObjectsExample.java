...
class ResourceA {
	...
	public synchronized void methodA(ResourceB resourceB) {
		System.out.println(String.format("%s: methodA 실행", Thread.currentThread().getName()));
	...
	public synchronized void methodA2() {
		System.out.println(String.format("%s: methodA2 실행", Thread.currentThread().getName()));
	}
}
...
class ResourceB {
	...
	public synchronized void methodB(ResourceA resourceA) {
		System.out.println(String.format("%s: methodB 실행", Thread.currentThread().getName()));
	...
	public synchronized void methodB2() {
		System.out.println(String.format("%s: methodB2 실행", Thread.currentThread().getName()));
	}
}
